...
function Navbar() {
  ...
  return (
    <>
      ...
      ${
        sticky
          ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-900 dark:text-white duration-300 transition-all ease-in-out flex z-50 "
          : ""
      }  `}
      >
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              ...
              <div className="">
                <a
                  className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 cursor-pointer duration-500 "
                  onClick={() =>
